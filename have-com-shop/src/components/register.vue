    ...
    <div id="form">
      <form @submit.prevent="handleSubmit">
        ...
        <fieldset id="fildpad">
          ...
          <input type="text" required placeholder="บ้านเลขที่" v-model="user.address.number">
          <input type="text"  placeholder="หมู่" v-model="user.address.moo">
          <input type="text"  placeholder="ถนน" v-model="user.address.road">
          <input type="text" required placeholder="ตำบล" v-model="user.address.tumbon">
          <input type="text" required placeholder="อำเภอ" v-model="user.address.aumper">
          <input type="text" required placeholder="จังหวัด" v-model="user.address.city">
          <input type="number" required placeholder="รหัสไปรษณีย์" v-model="user.address.code">
         </fieldset>
  ...
  data() {
    return {
      user: {
        ...
        last_name: "",
        phone: "",
        address: {number: '',road:'',moo:'',tumbon:'',aumper:'',city:'',code:''},
        password: "",
      },
    };
  },
